...
// `;
  ...
  return (
    ...
    <Grid container>
      ...
      {/* <Grid item xs={8} style={{marginRight:"-80px", marginLeft:'75px'}}>
        <Card style={{ width: '70vw' }}>
        <div style={{display:'flex'}}>
              <img src={'https://media.istockphoto.com/id/1485546774/photo/bald-man-smiling-at-camera-standing-with-arms-crossed.jpg?s=2048x2048&w=is&k=20&c=lOzPMobIPDUrcWRa1JRl4lyhIHBt8H18SB6sC9YXoys='} alt="Profile"  style={{ width: '50px', height: '50px', marginRight: '16px',marginBottom:'-20px',marginTop:'10px',borderRadius: '50%' }} /> */}
               {/* <div css={textStyle}> */}
                 {/* <Typography variant="h6" component="h3" gutterBottom  style={{marginTop:'10px', textAlign:'center'}}>
                   User Name
                 </Typography>

                 <Typography variant="body2" component="h3" gutterBottom style={{ marginTop: '38px',marginLeft:'-90px' ,textAlign: 'center' }}>
        Online
      </Typography>
              </div>
        </Card>
    ...
    {/* <Box >
    <Typography style={{ marginLeft: '36%', marginTop: '-145vh',backgroundColor: }} >lo</Typography>
  </Box>
     */}
  </ThemeProvider>
  );
